---
title:  "패키지관리자, 웹 다운로드 툴"
excerpt: "패키지관지라, 웹 다운로드 툴"
...
* 목차   
1. 패키지 관리자
2. yum local repo 생성 - 추후에 새로운 포스트에 정리 예정.
3. wget, curl
...
리눅스에서의 패키지 관리 시스템은 터미널 명령어로 진행해야 하기 때문에 GUI 방식인 웹 플랫폼 설치관리자보다 불편했고 처음 사용하는 사용자 입장에서  
불편하고 숙달하기 어려웠습니다.  
...
사용자가 로그인하지 않은 상태 동안에도 백그라운드 상태에서 동작할 수 있음을  
의미한다.
